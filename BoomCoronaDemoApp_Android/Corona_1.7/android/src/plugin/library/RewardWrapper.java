...
public class RewardWrapper implements NamedJavaFunction, BoomVideoTrackerInf {
	private static final String TAG = RewardWrapper.class.getSimpleName();
	Activity mActivity;
	LuaState mLuaState;

	public RewardWrapper(Activity activity) {
		mActivity = activity;
	}
		...
		if (mLuaState.isOpen()) {
			...
			case VIDEO_UNAVAILABLE:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "VIDEO_UNAVAILABLE" + "\") end",
						"=simple");
				break;
			case PLAYER_INITAILIZATION_ERROR:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "PLAYER_INITAILIZATION_ERROR"
						+ "\") end", "=simple");
				break;
			case VIDEO_FIRST_PLAY:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "VIDEO_FIRST_PLAY" + "\") end",
						"=simple");
				break;
			case VIDEO_END_PLAY:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "VIDEO_END_PLAY" + "\") end",
						"=simple");
				break;

			case ANNOTATION_CLICK:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "ANNOTATION_CLICK" + "\") end",
						"=simple");
			...
			case FACEBOOK_SHARE_COMPLETED:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "FACEBOOK_SHARE_COMPLETED"
						+ "\") end", "=simple");

				break;
			case GOOGLE_SHARE_COMPLETED:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "GOOGLE_SHARE_COMPLETED"
						+ "\") end", "=simple");
				break;
			case TWITTER_SHARE_COMPLETED:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "TWITTER_SHARE_COMPLETED"
						+ "\") end", "=simple");
				break;
			case VIDEO_PAUSED:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "VIDEO_PAUSED" + "\") end",
						"=simple");
				break;
			...
			case INSTAGRAM_URL:
				points = String.valueOf(operationResult.getPoints());
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "INSTAGRAM_URL" + "," + points
						+ "\") end", "=simple");
			...
			case SLIDESHARE_URL:
				points = String.valueOf(operationResult.getPoints());
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "SLIDESHARE_URL" + points
						+ "\") end", "=simple");
				break;
			case SURVEY_COMPLETED:
				points = String.valueOf(operationResult.getPoints());
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "SURVEY_COMPLETED" + points
						+ "\") end", "=simple");
				break;
			case BLOG_URL:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "SURVEY_COMPLETED" + "\") end",
						"=simple");
				break;
			case APP_INSTALLED:
				...
				points = String.valueOf(operationResult.getPoints());
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "APP_INSTALLED" + points
						+ "\") end", "=simple");
				break;
			...
			case INTERNET_UNAVAILABLE:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "INTERNET_UNAVAILABLE"
						+ "\") end", "=simple");
				break;

			case OFFER_AVAILED_ALREADY:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "OFFER_AVAILED_ALREADY"
						+ "\") end", "=simple");
				break;

			case INTERSTITIAL_LOADED:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "INTERSTITIAL_LOADED"
						+ "\") end", "=simple");
				break;

			case INTERSTITIAL_CLICKED:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "INTERSTITIAL_CLICKED"
						+ "\") end", "=simple");
				break;

			case INTERSTITIAL_CLOSED:
				mLuaState.load("function CallFunction_fromNative() "
						+ mEventName + "(\"" + "INTERSTITIAL_CLOSED"
						+ "\") end", "=simple");
				break;
			case AD_VIEW_LOADED:
				mLuaState.load("function CallFunction_fromNative() " + mEventName
